...
export const metadata: Metadata = {
  ...
  description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, Michelin-starred dining, and exceptional service.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, luxury suites, spa hotel, fine dining, concierge service",
  metadataBase: null,
  alternates: {},
  openGraph: {
    title: "Grand Luxe Hotel - 5-Star Luxury Accommodations",
